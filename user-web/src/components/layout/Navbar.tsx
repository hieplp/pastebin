...
function Brand() {
  return (
    ...
    >
      {/* Icon: lightning bolt in a tinted, bordered square */}
...
export function Navbar({
  ...
  return (
    <header
      className={cn(
        'relative z-10 border-b border-zinc-200/80 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-950/70 backdrop-blur-md px-4 sm:px-6 py-3.5 flex items-center justify-between gap-4 transition-colors',
        className,
      )}
    >
